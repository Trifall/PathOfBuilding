describe("Kinetic Fusillade", function()
	...
	it("uses the sequence range for non-stacking ailments", function()
		...
		assert.is_true(accumulatedBleedDPS / oneProjectileOutput.MainHand.BleedDPS > 1.66)
		assert.is_true(accumulatedIgniteDPS / oneProjectileOutput.MainHand.IgniteDPS > 1.66)
	end)
